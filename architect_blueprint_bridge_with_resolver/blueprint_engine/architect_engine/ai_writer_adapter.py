...
from architect_engine.synthesis import section_aspect_repetition_issues, section_synthesis_rule_issues, section_synthesis_rules
...
def _request_section(context, report_id, endpoint, token, title):
    ...
    issues.extend(section_aspect_repetition_issues(title,section.get("content",""),anchor))
    if issues:
